  ...
  const files = [
    {
      icon: FileCode,
      name: "main.py",
      description: "Entry point untuk menjalankan Aplikasi",
      color: "from-blue-500 to-blue-600",
    },
    {
      icon: Settings,
      name: "solver.py",
      description: "Tempat semua perhitungan Kalkulus",
      color: "from-purple-500 to-purple-600",
    },
    {
      icon: Palette,
      name: "gui_component.py",
      description: "Tempat untuk menggambar semua tombol dan tampilan",
      color: "from-pink-500 to-pink-600",
    },
    {
      icon: Layers,
      name: "event_handlers.py",
      description: "Untuk menangani semuah event(klik)",
      color: "from-orange-500 to-orange-600",
    },
    {
      icon: Terminal,
      name: "output_display.py",
      description: "File untuk menampilkan semua perhitungan ke layar",
